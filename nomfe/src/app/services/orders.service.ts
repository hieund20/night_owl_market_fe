...
export class OrdersService {
  ...
  public apiReceiveOrderGet(
    ...
    return this.httpClient.request<any>(
      'get',
      `${this.basePath}/orders/${id}/recieve_order/`,
      {
        headers: headers,
        withCredentials: this.configuration.withCredentials,
        observe: observe,
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public apiAvailableVoucherByIdOrderGet(
    accessToken: string,
    id: number,
    observe?: 'body',
    reportProgress?: boolean
  ...
  public apiAvailableVoucherByIdOrderGet(
    ...
    if (accessToken === null || accessToken === undefined) {
      throw new Error(
        'Required parameter accessToken was null or undefined when calling apiAvailableVoucherByIdProductGet.'
      );
    }
    if (id === null || id === undefined) {
      throw new Error(
    ...
    return this.httpClient.request<any>(
      'get',
      `${this.basePath}/orders/${id}/voucher-available/`,
      {
        headers: headers,
        withCredentials: this.configuration.withCredentials,
        observe: observe,
