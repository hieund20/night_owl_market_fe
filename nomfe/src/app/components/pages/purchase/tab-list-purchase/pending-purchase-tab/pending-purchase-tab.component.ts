...
@Component({
  ...
  templateUrl: './pending-purchase-tab.component.html',
  styleUrls: ['./pending-purchase-tab.component.scss'],
})
export class PendingPurchaseTabComponent implements OnInit {
  accessToken: string = '';
  dataTableList: any[] = [];
